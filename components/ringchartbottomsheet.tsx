  ...
  return(
    <>
      ...
      <View className='flex flex-row justify-between items-center py-3 px-5 border border-border rounded-lg'>
        <Text className='text-sm font-medium'>Aircon</Text>
      ...
      <View className='flex flex-row justify-between items-center py-3 px-5 border border-border rounded-lg'>
        <Text className='text-sm font-medium'>Fan</Text>
        <View className='flex flex-row gap-2'> 
      ...
      <View className='flex flex-row justify-between items-center py-3 px-5 border border-border rounded-lg'>
        <Text className='text-sm font-medium'>Others</Text>
        <View className='flex flex-row gap-2'> 
          <Text className='text-sm'>7%</Text>
          <Text className='text-sm text-gray-600 w-20 text-right'>2.0kWh</Text>
        </View>
      </View>
    </>
  )
